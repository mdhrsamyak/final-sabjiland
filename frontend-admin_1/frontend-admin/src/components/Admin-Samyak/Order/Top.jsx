...
function Top(props) {
  ...
  const pageCount = props.count ? Math.ceil(count / 2) : 0;
    ...
    <>
      <div className="top">
        ...
        <div className="filter">
          ...
          <div
            className={`filter-item ${status === "In Progress" ? "active" : ""
              }`}
            onClick={() => {
          ...
          <div className="search">
            ...
            <div>
              <Input
                ...
                type="text"
                placeholder="Search for order ID, customer name, order status"
              />
            </div>
          </div>
        ...
        <div className="paginate">
          ...
          >
            ...
            >
              <path
                fill="#000"
                fillOpacity={props.currentPage * selected >= count ? ".4" : "1"}
